...
> 역사 자료: 이 문서는 2026-09-18 개편 당시의 실행 기록이다. 당시 보관했던 이전 애플리케이션 폴더는 2026-09-22 현재 작업 트리에서 제거했다. 현재 구조와 실행 방법은 [README](../../README.md#문서), [아키텍처 지도](../ARCHITECTURE.md), [DEVELOPMENT.md](../DEVELOPMENT.md)를 따른다.
